...
namespace KBEngine
{
	...
	public abstract class MonsterBase : Entity
	{
		...
		{
			baseEntityCall = new EntityBaseEntityCall_MonsterBase();
		...
		{
			cellEntityCall = new EntityCellEntityCall_MonsterBase();
		...
		public override void callPropertysSetMethods()
		{
			...
			UInt32 oldval_entityNO = entityNO;
			Property prop_entityNO = pdatas[7];
			...
			Byte oldval_modelScale = modelScale;
			Property prop_modelScale = pdatas[10];
			...
			Byte oldval_moveSpeed = moveSpeed;
			Property prop_moveSpeed = pdatas[11];
