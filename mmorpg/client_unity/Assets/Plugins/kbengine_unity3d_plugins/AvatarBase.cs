...
namespace KBEngine
{
	...
	public abstract class AvatarBase : Entity
	{
		...
		public UInt32 lastSpaceUType = 0;
		public virtual void onLastSpaceUTypeChanged(UInt32 oldValue) {}
		...
		public override void onUpdatePropertys(Property prop, MemoryStream stream)
		{
			switch(prop.properUtype)
			{
				...
				case 16:
					...
					lastSpaceUType = stream.readUint32();
		...
		public override void callPropertysSetMethods()
		{
			...
			Int32 oldval_forbids = forbids;
			Property prop_forbids = pdatas[7];
			...
			UInt32 oldval_lastSpaceUType = lastSpaceUType;
			Property prop_lastSpaceUType = pdatas[8];
