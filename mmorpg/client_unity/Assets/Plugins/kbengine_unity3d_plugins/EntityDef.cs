...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			pAvatar_component1.properUtype = 17;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(component1 / 17).");

			Property pAvatar_component2 = new Property();
			pAvatar_component2.name = "component2";
			pAvatar_component2.properUtype = 22;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(component2 / 22).");

			Property pAvatar_component3 = new Property();
			pAvatar_component3.name = "component3";
			pAvatar_component3.properUtype = 23;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(component3 / 23).");
			...
			pAvatar_lastSpaceUType.aliasID = 12;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(own / 19).");

			Property pTest_state = new Property();
			pTest_state.name = "state";
			pTest_state.properUtype = 18;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Test), property(state / 18).");
			...
			pTestNoBase_own.properUtype = 25;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(own / 25).");

			Property pTestNoBase_state = new Property();
			pTestNoBase_state.name = "state";
			pTestNoBase_state.properUtype = 24;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(TestNoBase), property(state / 24).");
			...
			EntityDef.idmoduledefs[6] = pMonsterModule;
			...
			pMonster_moveSpeed.properUtype = 34;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), property(moveSpeed / 34).");
			...
			EntityDef.idmoduledefs[7] = pNPCModule;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(moveSpeed / 45).");
			...
			EntityDef.idmoduledefs[8] = pGateModule;
		...
		public static void initDefTypes()
		{
			...
			{
				UInt16 utype = 36;
				string typeName = "AnonymousArray_36";
				string name = "ENTITY_COMPONENT";
				DATATYPE_BASE val = null;
				EntityDef.datatypes.TryGetValue(name, out val);
				EntityDef.datatypes[typeName] = val;
