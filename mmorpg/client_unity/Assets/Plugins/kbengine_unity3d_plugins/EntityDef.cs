...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			pAccount_lastSelCharacter.aliasID = 3;
			...
			pAccount_onCreateAvatarResult.aliasID = 0;
			...
			pAccount_onRemoveAvatar.aliasID = 1;
			...
			Property pAvatar_lastSpaceUType = new Property();
			pAvatar_lastSpaceUType.name = "lastSpaceUType";
			pAvatar_lastSpaceUType.properUtype = 16;
			pAvatar_lastSpaceUType.properFlags = 8;
			pAvatar_lastSpaceUType.aliasID = 8;
			UInt32 Avatar_lastSpaceUType_defval;
			UInt32.TryParse("", out Avatar_lastSpaceUType_defval);
			pAvatar_lastSpaceUType.defaultVal = Avatar_lastSpaceUType_defval;
			pAvatarModule.propertys["lastSpaceUType"] = pAvatar_lastSpaceUType; 

			pAvatarModule.usePropertyDescrAlias = true;
			pAvatarModule.idpropertys[(UInt16)pAvatar_lastSpaceUType.aliasID] = pAvatar_lastSpaceUType;

			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Avatar), property(lastSpaceUType / 16).");

			Property pAvatar_level = new Property();
			pAvatar_level.name = "level";
			pAvatar_level.properUtype = 41002;
			pAvatar_level.properFlags = 8;
			pAvatar_level.aliasID = 9;
			...
			pAvatar_dialog_addOption.aliasID = 0;
			...
			pAvatar_dialog_close.aliasID = 1;
			...
			pAvatar_dialog_setText.aliasID = 2;
			...
			pAvatar_onRemoveSkill.aliasID = 5;
			...
			pMonster_modelScale.aliasID = 10;
			...
			pMonster_moveSpeed.properUtype = 23;
			pMonster_moveSpeed.properFlags = 4;
			pMonster_moveSpeed.aliasID = 11;
			...
			pMonster_recvDamage.methodUtype = 29;
			pMonster_recvDamage.aliasID = 0;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(Monster), method(recvDamage / 29).");
			...
			pNPC_moveSpeed.properUtype = 34;
			pNPC_moveSpeed.properFlags = 4;
			pNPC_moveSpeed.aliasID = 6;
			...
			//Dbg.DEBUG_MSG("EntityDef::initScriptModules: add(NPC), property(moveSpeed / 34).");
